...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey }, "b", function() awful.spawn.with_shell('xdg-open https://google.com') end,
...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey, "Control" }, "s", function() awful.spawn.with_shell("shutdown 0") end,
