...
awful.keyboard.append_global_keybindings({
    ...
    end, { description = "enable sleep mode", group = "launcher" }),
    ...
    end, { description = "set dual monitor properly", group = "launcher" }),

    -- currently not using vscodium
    -- awful.key({ modkey }, "c", function()
    --     awful.spawn.with_shell("codium")
    -- end, { description = "open vscodium", group = "launcher" }),
})

-- Volume Controls
local function notify_current_sound()
    local sound_level = require("config.sound")
    naughty.destroy_all_notifications()
    local volume = sound_level()
    naughty.notify({
        text = "Current Sound: " .. volume,
    })
end
...
local function notify_brightness()
    ...
    naughty.destroy_all_notifications()
    naughty.notify({ text = brightness })
end
